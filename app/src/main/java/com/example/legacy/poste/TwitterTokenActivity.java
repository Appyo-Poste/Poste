...
import com.example.legacy.poste.Dashboard;
import com.example.poste.R;
import com.example.legacy.poste.api.twitter.OAuth20GetAccessToken;
...
public class TwitterTokenActivity extends AppCompatActivity {
    ...
    private class AsyncGetTweets extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            pdLoading.dismiss();
            startActivity(new Intent(TwitterTokenActivity.this, Dashboard.class));
